...
#ifndef _asiAlgo_Defeaturing_HeaderFile
#define _asiAlgo_Defeaturing_HeaderFile
...
//! The asiAlgo_Defeaturing algorithm is the API algorithm intended for
...
//!
//! asiAlgo_Defeaturing aDF;             // De-Featuring algorithm
...
//!
class asiAlgo_Defeaturing : public BRepAlgoAPI_Algo
{
public:
...
public: //! @name Constructors
  ...
  //! Empty constructor
  //! \param[in] imperative plotter.
  asiAlgo_Defeaturing(ActAPI_PlotterEntry  plotter  = nullptr)
    :
    BRepAlgoAPI_Algo(), 
    myFillHistory(Standard_True)
  {
    myFeatureRemovalTool = asiAlgo_RemoveFaces(plotter);
  }
...
protected: //! @name Fields
  ...
  asiAlgo_RemoveFaces  myFeatureRemovalTool; //!< Tool for the features removal
  ActAPI_PlotterEntry  myPlotter;            //!< Plotter entry for drawing in the viewer.

};

#endif // _asiAlgo_Defeaturing_HeaderFile
