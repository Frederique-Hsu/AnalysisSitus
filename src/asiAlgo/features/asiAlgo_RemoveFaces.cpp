...
// purpose: 
//=======================================================================
void asiAlgo_RemoveFaces::fillPIConstants (const Standard_Real theWhole,
...
//=======================================================================
void asiAlgo_RemoveFaces::Perform(const Message_ProgressRange& theRange)
{
  try
  {
    OCC_CATCH_SIGNALS
...
//=======================================================================
void asiAlgo_RemoveFaces::CheckData()
{
...
//=======================================================================
void asiAlgo_RemoveFaces::PrepareFeatures(const Message_ProgressRange& theRange)
{
...
private: //! @name Private methods performing the operation
                           ...
                           const Message_ProgressRange& theRange)
  {
    ...
    for (Standard_Integer i = 1; i <= aNbFA && aPS.More(); ++i, aPS.Next())
    {
      ...
      //check for self intersecting face.
...
//          adjacent faces
//=======================================================================
void asiAlgo_RemoveFaces::RemoveFeatures(const Message_ProgressRange& theRange)
{
  // For each feature:
...
//=======================================================================
void asiAlgo_RemoveFaces::RemoveFeature
...
//=======================================================================
void asiAlgo_RemoveFaces::UpdateHistory()
{
  if (!HasHistory())
    return;
...
//=======================================================================
void asiAlgo_RemoveFaces::SimplifyResult(const Message_ProgressRange& theRange)
{
...
//=======================================================================
void asiAlgo_RemoveFaces::PostTreat()
{
