...
//purpose  : 
//=======================================================================
void asiAlgo_Defeaturing::Build(const Message_ProgressRange& theRange)
{
...
//purpose  : 
//=======================================================================
const TopTools_ListOfShape& asiAlgo_Defeaturing::Modified(const TopoDS_Shape& theS)
{
...
//purpose  : 
//=======================================================================
const TopTools_ListOfShape& asiAlgo_Defeaturing::Generated(const TopoDS_Shape& theS)
{
...
//purpose  : 
//=======================================================================
Standard_Boolean asiAlgo_Defeaturing::IsDeleted(const TopoDS_Shape& theS)
{
...
//purpose  : 
//=======================================================================
Standard_Boolean asiAlgo_Defeaturing::HasModified() const
{
...
//purpose  : 
//=======================================================================
Standard_Boolean asiAlgo_Defeaturing::HasGenerated() const
{
...
//purpose  : 
//=======================================================================
Standard_Boolean asiAlgo_Defeaturing::HasDeleted() const
{
