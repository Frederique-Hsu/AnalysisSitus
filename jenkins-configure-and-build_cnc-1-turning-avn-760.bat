...
echo "*** Running jenkins-configure-and-build_cnc-1-turning-avn-760.bat..."
...
-D3RDPARTY_DIR:PATH=%JENKINS_3RDPARTIES% -DINSTALL_DIR:PATH=../cmake-install-dir_cnc-1-turning-avn-760 ../
