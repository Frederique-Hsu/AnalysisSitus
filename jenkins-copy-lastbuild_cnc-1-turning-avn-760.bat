...
echo "*** Running jenkins-copy-lastbuild_cnc-1-turning-avn-760.bat..."
...
set "TEAMDIR=%JENKINS_LAST_BUILD_DIR%\%timestamp%-asitus_cnc-1-turning-avn-760"
if not exist %TEAMDIR% md %TEAMDIR%
xcopy /Y cmake-install-dir_cnc-1-turning-avn-760 %TEAMDIR% /s /e
