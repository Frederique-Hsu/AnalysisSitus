...
set datafile     public/cad/chamfers/chamfer_6.stp
set ref_ncomp    0
set ref_ncompso  0
set ref_nso      1
set ref_nshe     1
...
suppress-features {*}[get-face-ids -names face_1]
#
if { [check-validity] != 1 } {
...
if { [get-face-name -fid 3] != "face_8" } {
  error "Unexpected face name."
}
#
if { [get-face-name -fid 1] != "face_3" } {
  error "Unexpected face name."
}
#
if { [get-face-name -fid 6] != "face_9" } {
  error "Unexpected face name."
}
