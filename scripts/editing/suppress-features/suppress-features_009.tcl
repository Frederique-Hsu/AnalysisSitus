...
set datafile     public/cad/holes/00jZmMUdQKuCsLkMnE3ksmR9Aa28RU5uE59pK1Tc.stp
set ref_ncomp    0
set ref_ncompso  0
set ref_nso      1
set ref_nshe     1
...
suppress-features {*}[get-face-ids -names face_45 face_46]
#
if { [check-validity] != 1 } {
...
if { [get-face-name -fid 56] != "face_44" } {
  error "Unexpected face name."
}
#
if { [get-face-name -fid 57] != "face_47" } {
  error "Unexpected face name."
}
#
if { [get-face-name -fid 43] != "face_8" } {
  error "Unexpected face name."
}
#
if { [get-face-name -fid 48] != "face_7" } {
  error "Unexpected face name."
}
