...
set datafile     public/cad/nist/nist_ctc_02.stp
set ref_ncomp    4
set ref_ncompso  0
set ref_nso      1
set ref_nshe     2
...
if { [get-face-name -fid 340] != "face_340" } {
  error "Unexpected face name."
}
#
if { [get-face-name -fid 337] != "face_337" } {
  error "Unexpected face name."
}
#
if { [get-face-name -fid 338] != "face_338" } {
  error "Unexpected face name."
}
