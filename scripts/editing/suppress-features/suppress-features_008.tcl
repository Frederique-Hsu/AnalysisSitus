...
set datafile     public/cad/dfm/impossible-corner_01.step
set ref_ncomp    0
set ref_ncompso  0
set ref_nso      1
set ref_nshe     1
...
suppress-features {*}[get-face-ids -names face_3 face_2 face_1]
#
if { [check-validity] != 1 } {
...
if { [get-face-name -fid 3] != "face_5" } {
  error "Unexpected face name."
}
#
if { [get-face-name -fid 4] != "face_8" } {
  error "Unexpected face name."
}
#
if { [get-face-name -fid 1] != "face_6" } {
  error "Unexpected face name."
}
