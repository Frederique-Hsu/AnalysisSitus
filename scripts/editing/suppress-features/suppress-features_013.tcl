...
set datafile     public/cad/canrec/canrec_010.stp
set ref_ncomp    0
set ref_ncompso  0
set ref_nso      1
set ref_nshe     1
...
suppress-features {*}[get-face-ids -names face_3]
suppress-features {*}[get-face-ids -names face_12]
suppress-features {*}[get-face-ids -names face_9]
#
if { [check-validity] != 1 } {
...
if { [get-face-name -fid 10] != "face_11" } {
...
#
if { [get-face-name -fid 8] != "face_8" } {
  error "Unexpected face name."
}
#
if { [get-face-name -fid 24] != "face_25" } {
  error "Unexpected face name."
}
