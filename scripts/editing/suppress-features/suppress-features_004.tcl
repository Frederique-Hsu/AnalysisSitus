...
set datafile     public/cad/industrial/40mm_capot.stp
set ref_ncomp    1
set ref_ncompso  0
set ref_nso      1
set ref_nshe     1
...
if { [get-face-name -fid 67] != "face_120" } {
  error "Unexpected face name."
}
#
if { [get-face-name -fid 57] != "face_48" } {
  error "Unexpected face name."
}
#
if { [get-face-name -fid 116] != "face_57" } {
  error "Unexpected face name."
}
